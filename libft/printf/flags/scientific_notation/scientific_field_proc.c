...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   scientific_field_proc.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dbauduin <dbauduin@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/12 17:37:35 by dbauduin          #+#    #+#             */
/*   Updated: 2017/10/12 17:39:55 by dbauduin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <ft_printf.h>

static double	scientific_fld_cus(t_pdata *print, t_pf *fl, va_list ag, int i)
{
	double	floa;
	int		array[4];
	int		read;
...
double			scientific_field_proc(t_pdata *print, t_pf *flag, va_list args)
{
	...
	floa = scientific_fld_cus(print, flag, args, read);
	return (floa);
}
