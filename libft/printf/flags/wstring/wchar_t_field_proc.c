...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   wchar_t_field_proc.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dbauduin <dbauduin@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/12 17:59:37 by dbauduin          #+#    #+#             */
/*   Updated: 2017/10/12 18:00:51 by dbauduin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <ft_printf.h>

static wchar_t	*wchart_fld_cus(t_pdata *print, t_pf *fl, va_list ag, int i)
{
	wchar_t	*str;
	int		array[4];
	int		read;
	...
	while (i != 3)
	{
		...
		{
			str = get_next_wchart(&(read), fl->flag_arg_val, print, ag);
			val_tmp[3] = 1;
		}
...
wchar_t			*wchart_field_proc(t_pdata *print, t_pf *flag, va_list args)
{
	...
	{
		str = get_next_wchart(&read, flag->flag_arg_val, print, args);
		return (str);
	}
	str = wchart_fld_cus(print, flag, args, read);
	return (str);
}
